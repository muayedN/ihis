...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
        ...
        <tr>
        	...
        	<td class="admin2" colspan='3'><%=SH.writeDefaultTextArea(session, (TransactionVO)transaction, "ITEM_TYPE_REASONFORREFERRAL", 60, 1) %></td>
        </tr>
    </table>
	...
	<%
		String sCounterReferralButton="<input class='button' type='button' name='buttonCounterReferral' id='buttonCounterReferral' value='"+getTranNoLink("web","counterreferral",sWebLanguage)+"' onclick='doCounterReferral()'/>";
	%>
...
<script>  
  ...
  function doCounterReferral(){
	  var url = "<%=sCONTEXTPATH%>/healthrecord/createTransaction.do?be.mxs.healthrecord.createTransaction.transactionType=be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_COUNTERREFERRAL&referenceUID=<%=((TransactionVO)transaction).getUid()%>";
