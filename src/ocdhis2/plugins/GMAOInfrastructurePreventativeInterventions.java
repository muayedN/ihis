...
public class GMAOInfrastructurePreventativeInterventions extends DHIS2Plugin {
	...
	public Vector getResults(Date begin, Date end, Element dataset, Hashtable pluginParameters) {
		...
		Hashtable<String,Integer> operations = be.openclinic.assets.Util.getPreventativeInterventions("i",begin,end);
		Hashtable<String,Integer> plannedoperations = be.openclinic.assets.Util.getPlannedPreventativeInterventions("i",begin,end);
		Hashtable<String,Integer> expiredoperations = be.openclinic.assets.Util.getExpiredPlannedPreventativeInterventions("i",begin,end);
