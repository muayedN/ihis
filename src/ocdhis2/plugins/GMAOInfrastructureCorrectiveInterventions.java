...
public class GMAOInfrastructureCorrectiveInterventions extends DHIS2Plugin {
	...
	public Vector getResults(Date begin, Date end, Element dataset, Hashtable pluginParameters) {
		...
		Hashtable<String,Integer> operations = be.openclinic.assets.Util.getCorrectiveInterventions("i",begin,end,"");
		Hashtable<String,Integer> succesfuloperations = be.openclinic.assets.Util.getCorrectiveInterventions("i",begin,end,"ok");
